                ...
                return (
                  ...
                  >
                    <div className="flex gap-3 items-center">
                      <div className="w-16 h-16 sm:w-18 sm:h-18 bg-gray-50 rounded-lg overflow-hidden shrink-0 border border-gray-50">
                        {mainImage ? (
                          <img
                            src={mainImage}
                            alt={product.name}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 sticky top-4">
              ...
              <button 
                ...
                className="w-full py-3.5 bg-linear-to-r from-orange-500 to-green-600 text-white font-bold rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm mb-3"
              >
